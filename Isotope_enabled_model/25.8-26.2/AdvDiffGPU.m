...
%   boundary conditions
    ...
    k=1:nw2;
    Cg(536:572,k)=Cbound;
    C33g(536:572,k)=Cbound*R17eq;
    C34g(536:572,k)=Cbound*R18eq;
    C35g(536:572,k)=Cbound*R35eq;
    C36g(536:572,k)=Cbound*R36eq;

% Addition of photosynthetic endmember to NW corner of domain (comment out
% for respiration-only runs)
    Cg(524:533,(1:20))=Cbound*1.6;
    C33g(524:533,(1:20))=Cbound*R17eq+Cbound*0.6*R17p;
    C34g(524:533,(1:20))=Cbound*R18eq+Cbound*0.6*R18p;
    C35g(524:533,(1:20))=Cbound*R35eq+Cbound*0.6*R35p;
    C36g(524:533,(1:20))=Cbound*R36eq+Cbound*0.6*R36p;
