...
%
% This set of programs contains the initial settings and parameters for
% respiration-only runs on the 26.5-26.9 potential density surface, 
% including commented code for the "implicit addition" method of simulating
% the effects of photosynthesis in InitCon.
% 
...
figure
[z1,z2]=contour(x,y,O2sat,320:-20:0);
clabel(z1,z2)       

figure
[c,h]=contour(x,y,d18O,10:-1:0);
clabel(c,h)

figure
[c,h]=contour(x,y,D17O, 100:-10:0);
clabel(c,h)
